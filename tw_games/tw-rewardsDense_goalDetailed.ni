...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, you could, like, open the chest drawer. Then, pick up the old key from the chest drawer. After picking up the old key, assure that the ".
The objective part 1 is some text that varies. The objective part 1 is "wooden door is unlocked. Then, ensure that the wooden door is open. After pulling open the wooden door, take a trip east. And then, make sure that the screen door is wide open. After that, make an eff".
The objective part 2 is some text that varies. The objective part 2 is "ort to move east. With that done, attempt to take a trip south. Then, pick-up the carrot from the floor of the garden. And then, attempt to go to the north. If you can succeed at that, make an effort ".
The objective part 3 is some text that varies. The objective part 3 is "to take a trip west. And then, rest the carrot on the stove. Got that? Good!".
